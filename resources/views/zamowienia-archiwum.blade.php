        ...
        <table class="table table-striped" id="table">
            ...
            @foreach($zamowienia as $zamowienie)
                <tr>
                    ...
                    <a href="{{url("archiwalne_zamowienie/$zamowienie->id")}}" class="btn btn-secondary btn-sm">Pokaż</a>
                    {!! Form::open(['action' => ['ArchiwumController@destroy', $zamowienie->id], 'method' => 'DELETE', 'class' => 'd-inline-block']) !!}
